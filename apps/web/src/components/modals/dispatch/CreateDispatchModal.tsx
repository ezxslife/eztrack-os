...
import { createDispatchSchema, type CreateDispatchValues } from "@/lib/validations/dispatches";

interface CreateDispatchModalProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (data: CreateDispatchValues) => void | Promise<void>;
}
...
export function CreateDispatchModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await onSubmit(data as CreateDispatchValues);
      form.reset();
      onClose();
    } finally {
  ...
  return (
    <FormModal
      ...
      subtitle="Enter dispatch details for a new call"
      size="lg"
